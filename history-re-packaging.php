...
<head>
    <title>History - Re - Packing | PT Winson Prima Sejahtera</title>
                ...
                <table class="table table-sm table-striped" id="tbl-data">
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <th class="border sticky-top align-middle">Produk Awal</th>
                            <th class="border sticky-top align-middle text-right">Berat (KG)</th>
                            <th class="border sticky-top align-middle text-right">Hasil (KG)</th>
                        </tr>
                    </thead>

                    <tbody>
                        <?php
                            $lst = getHRPkgFrmTo($frm, $to, $jtgl, $db);

                            for($i = 0; $i < count($lst); $i++)
                            {
                        ?>
                        <tr>
                            <td class="border"><button class="btn btn-sm border boder-info btn-vhst-rpkg" data-value="<?php echo UE64($lst[$i][0]);?>"><img src="./bin/img/icon/view-list-icon.png" alt="" width="18"></button></td>
                            ...
                            <?php
                                ...
                                {
                                    $nma = $lst[$i][14]." / ".$lst[$i][15];

                                    if(strcasecmp($lst[$i][16], "") != 0){
                                        $nma .= " / ".$lst[$i][16];
                                    }

                                    if(strcasecmp($lst[$i][17], "") != 0){
                                        $nma .= " / ".$lst[$i][17];
                                    }
                            ?>
                ...
                <div class="modal-dialog modal-dialog-centered mw-70p" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body py-1">
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 my-2">Tgl : <span id="tgl_bfr"></span></div>
                                <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 my-2">Produk Awal : <span id="pro_bfr"></span></div>
                                <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 my-2">Berat (KG) : <span id="weight_bfr"></span></div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 my-2">Tgl : <span id="tgl_afr"></span></div>
                                <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 my-2">Produk Awal : <span id="pro_afr"></span></div>
                                <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 my-2">Berat (KG) : <span id="weight_afr"></span></div>
                            </div>
                            <div class="table-responsive mxh-60vh">
                                <table class="table table-sm table-striped">
                                    <thead class="thead-dark">
