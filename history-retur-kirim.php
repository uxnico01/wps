...
<head>
    <title>History - Retur Kirim | PT Winson Prima Sejahtera</title>
                ...
                <table class="table table-sm table-striped" id="tbl-data">
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <th class="border sticky-top align-middle">Dari P/O</th>
                            <th class="border sticky-top align-middle text-right">Total Retur (KG)</th>
                    ...
                    <tbody>
                        <?php
                            $lst = getHstRKirimFrmTo($frm, $to, $jtgl, $db);

                            for($i = 0; $i < count($lst); $i++)
                            {
                        ?>
                        <tr>
                            <td class="border"><button class="btn btn-sm border boder-info btn-vhst-rkrm" data-value="<?php echo UE64($lst[$i][0]);?>"><img src="./bin/img/icon/view-list-icon.png" alt="" width="18"></button></td>
                            ...
                            <?php
                                ...
                                {
                            ?>
                            <td class="border"><?php echo date('d/m/Y', strtotime($lst[$i][4]));?></td>
                            ...
                            <?php
                                ...
                                {
                            ?>
                            <td class="border"><?php echo date('d/m/Y', strtotime($lst[$i][10]));?></td>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body py-1">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-12 col-md-4 col-lg-3 col-xl-3 my-2">No Retur : <span id="id_bfr"></span></div>
                                <div class="col-12 col-sm-12 col-md-4 col-lg-3 col-xl-3 my-2">Customer : <span id="cus_bfr"></span></div>
                                <div class="col-12 col-sm-12 col-md-4 col-lg-3 col-xl-3 my-2">Dari PO : <span id="po_bfr"></span></div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-12 col-md-4 col-lg-3 col-xl-3 my-2">No Retur : <span id="id_afr"></span></div>
                                <div class="col-12 col-sm-12 col-md-4 col-lg-3 col-xl-3 my-2">Customer : <span id="cus_afr"></span></div>
                                <div class="col-12 col-sm-12 col-md-4 col-lg-3 col-xl-3 my-2">Dari PO : <span id="po_afr"></span></div>
