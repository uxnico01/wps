...
<head>
    <title>History - Pinjaman | PT Winson Prima Sejahtera</title>
        ...
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 m-0 p-0">
            ...
            <div class="table-responsive mh-70vh mxh-70vh">
                <table class="table table-sm table-striped" id="tbl-data">
                    ...
                    <tbody>
                        <?php
                            $lst = getHstPjmFrmTo($frm, $to, $jtgl);

                            for($i = 0; $i < count($lst); $i++)
                            {
                                if(strcasecmp($lst[$i][3],"NEW") != 0)
                                    $sup = getSupID($lst[$i][6]);
                                else
                                    $sup = getSupID($lst[$i][15]);
                        ?>
                        <tr>
                            <td class="border"><button class="btn btn-sm border boder-info btn-vhst-pjm" data-value="<?php echo UE64($lst[$i][0]);?>"><img src="./bin/img/icon/view-list-icon.png" alt="" width="18"></button></td>
                            ...
                            <td class="border"><?php echo date('d/m/Y H:i', strtotime($lst[$i][12]));?></td>
                            <?php
                                }
                                else
                                {
                            ...
                            <td class="border"><?php echo date('d/m/Y', strtotime($lst[$i][14]));?></td>
                            <td class="border"><?php echo $sup[1];?></td>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body pt-1 pb-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-12 col-md-4 col-lg-3 col-xl-3 my-2">Jlh : <span id="jlh_bfr"></span></div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-12 col-md-4 col-lg-3 col-xl-3 my-2">Jlh : <span id="jlh_afr"></span></div>
