...
<head>
    <title>History - Penyesuaian Stok | PT Winson Prima Sejahtera</title>
    ...
    <div class="col-12 py-3">
        ...
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 m-0 p-0">
            <div class="my-2 d-none">
                <h5>History Penyesuaian Stok</h5>
            ...
            <div class="table-responsive mh-70vh mxh-70vh">
                <table class="table table-sm table-striped" id="tbl-data">
                    ...
                    <tbody>
                        <?php
                            $lst = getHstPsFrmTo($frm, $to, $jtgl);

                            for($i = 0; $i < count($lst); $i++)
                            {
                        ?>
                        <tr>
                            <td class="border"><button class="btn btn-sm border boder-info btn-vhst-ps" data-value="<?php echo UE64($lst[$i][0]);?>"><img src="./bin/img/icon/view-list-icon.png" alt="" width="18"></button></td>
                            ...
                            <?php
                                ...
                                {
                            ?>
                            <td class="border"><?php echo date('d/m/Y', strtotime($lst[$i][7]));?></td>
                            ...
                            <td class="border"><?php echo date('d/m/Y H:i', strtotime($lst[$i][16]));?></td>
                            <?php
                                }
                            ?>
                        </tr>
