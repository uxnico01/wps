...
<head>
    <title>History - Sawing | PT Winson Prima Sejahtera</title>
                ...
                <table class="table table-sm table-striped" id="tbl-data">
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <th class="border sticky-top text-right">Tahapan Ke</th>
                    ...
                    <tbody>
                        <?php
                            $lst = getHstSawFrmTo($frm, $to, $jtgl);
                        ...
                        ?>
                        <tr>
                            <td class="border"><button class="btn btn-sm border boder-info btn-vhst-saw" data-value="<?php echo UE64($lst[$i][0]);?>"><img src="./bin/img/icon/view-list-icon.png" alt="" width="18"></button></td>
                            ...
                            <td class="border text-right"><?php echo number_format($lst[$i][13],0,',','.');?></td>
                            <td class="border text-right"><?php if(strcasecmp($lst[$i][27],"0") == 0) echo ""; else echo $lst[$i][27];?></td>
                            ...
                            <td class="border text-right"><?php echo number_format($lst[$i][23],0,',','.');?></td>
                            <td class="border text-right"><?php if(strcasecmp($lst[$i][26],"0") == 0) echo ""; else echo $lst[$i][26];?></td>
                            <td class="border"><?php echo $tmrgn." ".$lst[$i][17];?></td>
                            <td class="border"><?php echo $lst[$i][18];?></td>
                            <td class="border"><?php echo date('d/m/Y H:i', strtotime($lst[$i][19]));?></td>
                            <?php
                                }
                            ?>
                        </tr>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body py-1">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-12 col-md-4 col-lg-3 col-xl-3 my-2">Produk : <span id="pro_bfr"></span></div>
                                <div class="col-12 col-sm-12 col-md-4 col-lg-3 col-xl-3 my-2">Oz : <span id="kate_bfr"></span></div>
                                <div class="col-12 col-sm-12 col-md-4 col-lg-3 col-xl-3 my-2">Cut Style : <span id="skate_bfr"></span></div>
                                <div class="col-12 col-sm-12 col-md-4 col-lg-3 col-xl-3 my-2">Berat (KG) : <span id="brt_bfr"></span></div>
                                <div class="col-12 col-sm-12 col-md-4 col-lg-3 col-xl-3 my-2">Tahapan Ke : <span id="thp_bfr"></span></div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-12 col-md-4 col-lg-3 col-xl-3 my-2">Produk : <span id="pro_afr"></span></div>
                                <div class="col-12 col-sm-12 col-md-4 col-lg-3 col-xl-3 my-2">Oz : <span id="kate_afr"></span></div>
                                <div class="col-12 col-sm-12 col-md-4 col-lg-3 col-xl-3 my-2">Cut Style : <span id="skate_afr"></span></div>
                                <div class="col-12 col-sm-12 col-md-4 col-lg-3 col-xl-3 my-2">Berat (KG) : <span id="brt_afr"></span></div>
                                <div class="col-12 col-sm-12 col-md-4 col-lg-3 col-xl-3 my-2">Tahapan Ke : <span id="thp_afr"></span></div>
