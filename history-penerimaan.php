...
<head>
    <title>History - Penerimaan | PT Winson Prima Sejahtera</title>
    ...
    <div class="col-12 py-3">
        <div class="col-12 p-0 no-print">
            <form method="get" class="row">
                <div class="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-2 my-2 offset-xl-2">
                ...
                <table class="table table-sm table-striped" id="tbl-data">
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <th class="border sticky-top text-right">Pot Dll</th>
                            <th class="border sticky-top text-right">Tbh Dll</th>
                    ...
                    <tbody>
                        <?php
                            $lst = getHstTrmFrmTo($frm, $to, $jtgl);
                        ...
                        ?>
                        <tr>
                            <td class="border"><button class="btn btn-sm border boder-info btn-vhst-trm" data-value="<?php echo UE64($lst[$i][0]);?>"><img src="./bin/img/icon/view-list-icon.png" alt="" width="18"></button></td>
                            ...
                            <td class="border text-right"><?php if(isDecimal($lst[$i][26])) echo number_format($lst[$i][26], 2, '.', ','); else echo number_format($lst[$i][26], 0, '.', ','); if(strcasecmp($lst[$i][27],"") != 0) echo " (".$lst[$i][27].")";?></td>
                            <td class="border text-right"><?php if(isDecimal($lst[$i][28])) echo number_format($lst[$i][28], 2, '.', ','); else echo number_format($lst[$i][28], 0, '.', ',');?></td>
                            <td class="border text-right"><?php if(isDecimal((double)$lst[$i][32])) echo number_format($lst[$i][32], 2, '.', ','); else echo number_format($lst[$i][32], 0, '.', ',');?></td>
                            <td class="border text-right"><?php if(isDecimal((double)$lst[$i][34])) echo number_format($lst[$i][34], 2, '.', ','); else echo number_format($lst[$i][34], 0, '.', ',');?></td>
                            <td class="border"><?php echo $lst[$i][9];?></td>
                            <td class="border"><?php echo $lst[$i][10];?></td>
                            <td class="border"><?php echo $lst[$i][11];?></td>
                            <td class="border"><?php echo $lst[$i][24];?></td>
                            ...
                            <td class="border text-right"><?php if(isDecimal((double)$lst[$i][29])) echo number_format($lst[$i][29], 2, '.', ','); else echo number_format($lst[$i][29], 0, '.', ','); if(strcasecmp($lst[$i][30],"") != 0) echo " (".$lst[$i][30].")";?></td>
                            <td class="border text-right"><?php if(isDecimal((double)$lst[$i][31])) echo number_format($lst[$i][31], 2, '.', ','); else echo number_format($lst[$i][31], 0, '.', ',');?></td>
                            <td class="border text-right"><?php if(isDecimal($lst[$i][33])) echo number_format($lst[$i][33], 2, '.', ','); else echo number_format($lst[$i][33], 0, '.', ',');?></td>
                            <td class="border text-right"><?php if(isDecimal($lst[$i][35])) echo number_format($lst[$i][35], 2, '.', ','); else echo number_format($lst[$i][35], 0, '.', ',');?></td>
                            <td class="border"><?php echo $lst[$i][19];?></td>
                            <td class="border"><?php echo $lst[$i][20];?></td>
                            <td class="border"><?php echo $lst[$i][21];?></td>
                            <td class="border"><?php echo $lst[$i][25];?></td>
                ...
                <div class="modal-dialog modal-dialog-centered mw-90p" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body pt-1 pb-3">
                            <h6 class="mt-2 mb-0">Perbedaan</h6><hr>
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-4 col-lg-3 col-xl-3 my-2">ID : <span id="id_pbd"></span></div>
                                <div class="col-12 col-sm-12 col-md-4 col-lg-3 col-xl-3 my-2">Tgl : <span id="tgl_pbd"></span></div>
                                <div class="col-12 col-sm-12 col-md-4 col-lg-3 col-xl-3 my-2">Supplier : <span id="sup_pbd"></span></div>
                                <div class="col-12 col-sm-12 col-md-4 col-lg-3 col-xl-3 my-2">BB : <span id="bb_pbd"></span></div>
                                <div class="col-12 col-sm-12 col-md-4 col-lg-3 col-xl-3 my-2">Poto : <span id="poto_pbd"></span></div>
                                <div class="col-12 col-sm-12 col-md-4 col-lg-3 col-xl-3 my-2">Ket1 : <span id="ket1_pbd"></span></div>
                                <div class="col-12 col-sm-12 col-md-4 col-lg-3 col-xl-3 my-2">Ket2 : <span id="ket2_pbd"></span></div>
                                <div class="col-12 col-sm-12 col-md-4 col-lg-3 col-xl-3 my-2">Ket3 : <span id="ket3_pbd"></span></div>
                                <div class="col-12 col-sm-12 col-md-4 col-lg-3 col-xl-3 my-2">Kota : <span id="kota_pbd"></span></div>
                                <div class="col-12 col-sm-12 col-md-4 col-lg-3 col-xl-3 my-2 d-none">DLL : <span class="d-none" id="dll_pbd"></span></div>
                                <div class="col-12 col-sm-12 col-md-4 col-lg-3 col-xl-3 my-2">DP : <span id="dp_pbd"></span></div>
                                <div class="col-12 col-sm-12 col-md-4 col-lg-3 col-xl-3 my-2">Pot Dll : <span id="pdll_pbd"></span></div>
                                <div class="col-12 col-sm-12 col-md-4 col-lg-3 col-xl-3 my-2">Tbh Dll : <span id="tdll_pbd"></span></div>
                            </div>
                            <div class="table-responsive mxh-40vh">
                                <table class="table table-sm table-striped">
                                    ...
                                    <tbody id="lhst_pbd"></tbody>
                                </table>
                            </div>

                            <h6 class="mt-4 mb-0">Sebelum</h6><hr>
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-12 col-md-4 col-lg-3 col-xl-3 my-2">Kota : <span id="kota_bfr"></span></div>
                                <div class="col-12 col-sm-12 col-md-4 col-lg-3 col-xl-3 my-2 d-none">DLL : <span class="" id="dll_bfr"></span></div>
                                <div class="col-12 col-sm-12 col-md-4 col-lg-3 col-xl-3 my-2">DP : <span id="dp_bfr"></span></div>
                                <div class="col-12 col-sm-12 col-md-4 col-lg-3 col-xl-3 my-2">Pot Dll : <span id="pdll_bfr"></span></div>
                                <div class="col-12 col-sm-12 col-md-4 col-lg-3 col-xl-3 my-2">Tbh Dll : <span id="tdll_bfr"></span></div>
                            </div>
                            <div class="table-responsive mxh-40vh">
                                <table class="table table-sm table-striped">
                                    <thead class="thead-dark">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-12 col-md-4 col-lg-3 col-xl-3 my-2">Kota : <span id="kota_afr"></span></div>
                                <div class="col-12 col-sm-12 col-md-4 col-lg-3 col-xl-3 my-2 d-none">DLL : <span class="d-none" id="dll_afr"></span></div>
                                <div class="col-12 col-sm-12 col-md-4 col-lg-3 col-xl-3 my-2">DP : <span id="dp_afr"></span></div>
                                <div class="col-12 col-sm-12 col-md-4 col-lg-3 col-xl-3 my-2">Pot Dll : <span id="pdll_afr"></span></div>
                                <div class="col-12 col-sm-12 col-md-4 col-lg-3 col-xl-3 my-2">Tbh Dll : <span id="tdll_afr"></span></div>
                            </div>
                            <div class="table-responsive mxh-40vh">
                                <table class="table table-sm table-striped">
                                    <thead class="thead-dark">
