...
<head>
    <title>History - Cutting | PT Winson Prima Sejahtera</title>
        ...
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 m-0 p-0">
            ...
            <div class="table-responsive mh-70vh mxh-70vh">
                <table class="table table-sm table-striped" id="tbl-data">
                    ...
                    <tbody>
                        <?php
                            $lst = getHstCutFrmTo($frm, $to, $jtgl);

                            for($i = 0; $i < count($lst); $i++)
                            {
                                $tmrgn = "";
                                if(strcasecmp($lst[$i][6],"1") == 0)
                                    $tmrgn = "<";
                                else if(strcasecmp($lst[$i][6],"2") == 0)
                                    $tmrgn = ">";
                        ?>
                        <tr>
                            <td class="border"><button class="btn btn-sm border boder-info btn-vhst-cut" data-value="<?php echo UE64($lst[$i][0]);?>"><img src="./bin/img/icon/view-list-icon.png" alt="" width="18"></button></td>
                            ...
                            <td class="border"><?php echo $tmrgn." ".$lst[$i][13];?></td>
                            <td class="border"><?php echo $lst[$i][14];?></td>
                            <td class="border"><?php echo date('d/m/Y H:i', strtotime($lst[$i][15]));?></td>
                            <?php
                                }
                            ?>
                        </tr>
                ...
                <div class="modal-dialog modal-dialog-centered mw-90p" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body pt-1 pb-3">
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 my-2">Tgl : <span id="tgl_pbd"></span></div>
                                <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 my-2">Margin : <span id="mrgn_pbd"></span></div>
                            </div>
                            <div class="table-responsive mxh-40vh">
                                <table class="table table-sm table-striped">
                                    <thead class="thead-dark">
                                        <tr>
                                            <th class="border sticky-top">No Sample</th>
                                            ...
                                            <th class="border sticky-top text-right">Cut 1</th>
                                            <th class="border sticky-top text-right">Cut 2</th>
                                            <th class="border sticky-top text-right">Cut 3</th>
                                            <th class="border sticky-top text-right">Cut 4</th>
                                            <th class="border sticky-top text-right">Cut 5</th>
                                            <th class="border sticky-top text-right">Cut 6</th>
