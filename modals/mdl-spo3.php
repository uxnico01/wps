<div class="modal fade" id="mdl-spo3" tabindex="-1" role="dialog" aria-labelledby="mdl-spo3" aria-hidden="true">
            ...
            <div class="modal-body pt-1">
                <div class="col-12 m-0 p-0 my-2">
                    <div class="input-group">
                        <input type="text" class="form-control" id="txt-srch-spo3" autocomplete="off" placeholder="Search P/O" data-value="">
                        
                        <div class="input-group-append">
                            <button class="btn btn-light border" id="btn-srch-spo3"><img src="<?php if(file_exists("./bin/img/icon/search.png")) echo "./bin/img/icon/search.png"; else echo "../bin/img/icon/search.png";?>" alt="Search" width="20"></button>
                        </div>
                    </div>
                </div>
