<div class="modal fade" id="mdl-ssup" tabindex="-1" role="dialog" aria-labelledby="mdl-ssup" aria-hidden="true">
            ...
            <div class="modal-body pt-1">
                <div class="col-12 m-0 p-0 my-2">
                    <div class="input-group">
                        <input type="text" class="form-control" id="txt-srch-ssup" autocomplete="off" placeholder="Search Supplier" data-value="">
                        
                        <div class="input-group-append">
                            <button class="btn btn-light border" id="btn-srch-ssup"><img src="./bin/img/icon/search.png" alt="Search" width="20"></button>
                        </div>
                    </div>
                </div>
                            ...
                            <?php
                                ...
                                for($i = 0; $i < count($lst); $i++)
                                {
                                    if($i == 50)
                                        break;
                            ?>
                            <tr onclick="chgSup('<?php echo UE64($lst[$i][0]);?>')">
