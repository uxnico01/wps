<div class="modal fade" id="mdl-nwd" tabindex="-1" role="dialog" aria-labelledby="mdl-nwd" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body pt-1">
                <div class="alert alert-danger d-none" id="div-err-wd-1">Harap isi semua data dengan tanda * !!!</div>

                <div class="alert alert-danger d-none" id="div-err-wd-2">Terdapat data penarikan dengan ID ini !!!</div>

                <div class="alert alert-danger d-none" id="div-err-wd-3">Data supplier tidak ditemukan !!!</div>

                <div class="alert alert-danger d-none" id="div-err-wd-4">Jumlah melebihi simpanan !!!</div>

                <div class="alert alert-success d-none" id="div-scs-wd-1">Penarikan berhasil ditambahkan !!!</div>
                    ...
                    <div class="col-9">
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <button class="btn btn-light border" type="button" data-value="#mdl-nwd" data-target="#mdl-ssup" data-toggle="modal" data-backdrop="static" data-keyboard="false"><img src="./bin/img/icon/folder-icon.png" width="20" alt="Pilih"></button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-9"><input type="text" class="form-control" id="txt-sjlh" name="txt-sjlh" placeholder="" autocomplete="off" readonly></div>
                </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" id="btn-snwd">Simpan</button>
            </div>
        </div>
    </div>
</div>