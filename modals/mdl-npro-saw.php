<div class="modal fade" id="mdl-npro-saw" tabindex="-1" role="dialog" aria-labelledby="mdl-npro-vac" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-50p" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Tambah Produk Sawing</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close" data-target="#mdl-esaw" data-toggle="modal">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>

            <div class="modal-body pt-1">
                <div class="alert alert-danger d-none" id="div-err-saw-pro-1">Harap isi semua data dengan tanda * !!!</div>

                <div class="alert alert-success d-none" id="div-scs-saw-pro-1">Produk berhasil ditambahkan !!!</div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" id="btn-sesaw-pro">Simpan</button>
            </div>
        </div>
    </div>
</div>