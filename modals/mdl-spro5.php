<div class="modal fade" id="mdl-spro5" tabindex="-1" role="dialog" aria-labelledby="mdl-spro5" aria-hidden="true">
            ...
            <div class="modal-body pt-1">
                <div class="col-12 m-0 p-0 my-2">
                    <div class="input-group">
                        <input type="text" class="form-control" id="txt-srch-spro5" autocomplete="off" placeholder="Search Produk" data-value="">
                        
                        <div class="input-group-append">
                            <button class="btn btn-light border" id="btn-srch-spro5"><img src="./bin/img/icon/search.png" alt="Search" width="20"></button>
                        </div>
                    </div>
                </div>
