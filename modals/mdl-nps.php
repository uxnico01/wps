<div class="modal fade" id="mdl-nps" tabindex="-1" role="dialog" aria-labelledby="mdl-nps" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-50p" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Tambah Penyesuaian Stok</h5>
            ...
            <div class="modal-body pt-1">
                <div class="alert alert-danger d-none" id="div-err-ps-1">Harap isi semua data dengan tanda * !!!</div>

                <div class="alert alert-success d-none" id="div-scs-ps-1">Penyesuaian stok berhasil ditambahkan !!!</div>
                            ...
                            <div class="col-9">
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <button class="btn btn-light border btn-spro3" type="button" data-value="#mdl-nps" data-target="#mdl-spro3" data-toggle="modal" data-backdrop="static" data-keyboard="false"><img src="./bin/img/icon/folder-icon.png" width="20" alt="Pilih"></button>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" id="btn-snps">Simpan</button>
            </div>
        </div>
    </div>
</div>