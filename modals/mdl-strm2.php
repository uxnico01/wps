<div class="modal fade" id="mdl-strm2" tabindex="-1" role="dialog" aria-labelledby="mdl-strm2" aria-hidden="true">
            ...
            <div class="modal-body pt-1">
                <div class="col-12 m-0 p-0 my-2">
                    <div class="input-group">
                        <input type="text" class="form-control" id="txt-srch-strm-itm" autocomplete="off" placeholder="Search Penerimaan" data-value="">
                        
                        <div class="input-group-append">
                            <button class="btn btn-light border" id="btn-srch-strm-itm"><img src="./bin/img/icon/search.png" alt="Search" width="20"></button>
                        </div>
                    </div>
                </div>
                            ...
                            <?php
                                ...
                                for($i = 0; $i < count($lst); $i++)
                                {
                                    if($i == 50)
                                        break;
                            ?>
                            <tr onclick="chgTrmItm('<?php echo UE64($lst[$i][0]);?>', '<?php echo UE64($lst[$i][5]);?>', '<?php echo UE64($lst[$i][6]);?>', '<?php echo UE64($lst[$i][7]);?>', '<?php echo UE64($lst[$i][8]);?>', '<?php echo UE64($lst[$i][3]);?>', '<?php echo UE64($lst[$i][4]);?>')">
