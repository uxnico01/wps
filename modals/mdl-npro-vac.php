<div class="modal fade" id="mdl-npro-vac" tabindex="-1" role="dialog" aria-labelledby="mdl-npro-vac" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-50p" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Tambah Produk Vaccuum</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close" data-target="#mdl-evac" data-toggle="modal">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>

            <div class="modal-body pt-1">
                <div class="alert alert-danger d-none" id="div-err-vac-pro-1">Harap isi semua data dengan tanda * !!!</div>

                <div class="alert alert-success d-none" id="div-scs-vac-pro-1">Produk berhasil ditambahkan !!!</div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                        <div class="row mt-2">
                            ...
                            <div class="col-9">
                                <select name="edt-slct-grd" id="edt-slct-grd" class="custom-select">
                                </select>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" id="btn-sevac-pro">Simpan</button>
            </div>
        </div>
    </div>
</div>