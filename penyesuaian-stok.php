<?php
    ...
    $ttl = "Transaksi - Penyesuaian Stok";
?>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="col-12 p-0">
            <div class="row sticky-top bg-light">
                <div class="col-12 col-sm-12 col-md-7 col-lg-6 col-xl-6">
                    <?php
                        if (CekAksUser(substr($duser[7], 152, 1))) {
                    ?>
                        <button class="btn btn-outline-success m-1" id="btn-nps"><img src="./bin/img/icon/plus.png" width="20" alt="Add"> <span class="small">Tambah Penyesuaian Stok</span></button>
                    <?php
                        }
                    ?>
                </div>
                ...
                <div class="offset-lg-2 offset-xl-3 col-12 col-sm-12 col-md-5 col-lg-4 col-xl-3 py-1">
                    <div class="input-group">
                        <input type="text" class="form-control text-right txt-srch" id="txt-srch-ps" placeholder="Cari Penyesuaian Stok" autocomplete="off" autofocus>

                        <div class="input-group-append">
                            <input type="text" class="hdn-date d-none">
                            <button class="btn btn-light border" id="btn-srch-ps"><img src="./bin/img/icon/search.png" alt="Cari" width="20"></button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <table class="table table-sm table-hover table-striped">
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <th class="border sticky-top d-none">Keterangan</th>
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="border mw-15p">
                                        <button class="btn btn-light border-warning mb-1 p-1" onclick="ePs('<?php echo UE64($lst[$i][0]); ?>')"><img src="./bin/img/icon/edit-icon.png" alt="Ralat" width="18"></button>
                                    <?php
                                        if (CekAksUser(substr($duser[7], 154, 1))) {
                                    ?>
                                        <button class="btn btn-light border-danger mb-1 p-1" onclick="delPs('<?php echo UE64($lst[$i][0]); ?>')"><img src="./bin/img/icon/delete-icon.png" alt="Hapus" width="18"></button>
                                    <?php
                                        }
                                    ?>
                                        <button class="btn btn-light border-secondary mb-1 p-1" onclick="viewPs('<?php echo UE64($lst[$i][0]); ?>')"><img src="./bin/img/icon/list-icon.png" alt="Lihat Penyesuaian Stok" width="20"></button>
                                </td>
                            </tr>
                        <?php
                        }
            ...
            <div class="lmodals">
                <?php
                    if (CekAksUser(substr($duser[7], 152, 1)))
                        require("./modals/mdl-nps.php");

                    //if (CekAksUser(substr($duser[7], 153, 1))) {
                ?>
                    <div class="modal fade" id="mdl-eps" tabindex="-1" role="dialog" aria-labelledby="mdl-eps" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered mw-70p" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title">Ralat Penyesuaian Stok</h5>
                                ...
                                <div class="modal-body pt-1">
                                    <div class="alert alert-danger d-none" id="div-edt-err-ps-1">Harap isi semua data dengan tanda * !!!</div>

                                    <div class="alert alert-danger d-none" id="div-edt-err-ps-2">Data produk tidak ditemukan !!!</div>

                                    <div class="alert alert-danger d-none" id="div-edt-err-ps-3">Data penyesuaian stok tidak ditemukan !!!</div>

                                    <div class="alert alert-danger d-none" id="div-edt-err-ps-4">Data gudang tidak ditemukan !!!</div>

                                    <div class="alert alert-success d-none" id="div-edt-scs-ps-1">Penyesuaian Stok berhasil diubah !!!</div>
                                    ...
                                    <div class="col-12 my-2 p-0">
                                        <button class="btn btn-light border border-success btn-ps-pro" data-toggle="modal" data-target="#mdl-npro-ps" data-keyboard="false" data-backdrop="static" data-dismiss="modal"><img src="./bin/img/icon/plus.png" alt="" width="18"> <span class="small">Pilih Produk</span></button>
                                    </div>
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-primary" id="btn-seps" data-count="">Simpan</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                //}
                    ...
                    require("./modals/mdl-npro-ps.php");
